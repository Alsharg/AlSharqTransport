        ...
        <Pressable
          onPress={() => {
            if (driverLocation && mapRef.current) {
              mapRef.current.animateToRegion({ ...driverLocation, latitudeDelta: 0.01, longitudeDelta: 0.01 }, 500);
            }
          }}
        ...
        <Animated.View entering={FadeInDown.duration(400)} style={styles.infoPanel}>
          <View style={styles.infoPanelHeader}>
            <View style={[styles.statusChip, { backgroundColor: statusColor + '15' }]}>
              ...
              <Text style={[styles.statusText, { color: statusColor }]}>{getTripStatusLabel(trip.status)}</Text>
            </View>
